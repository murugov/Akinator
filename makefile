...
akinator: main_akinator.cpp $(COMMON_FILES) $(TREE_FILES) $(AKINATOR_FILES)
	@echo "-----------------------------------------------------------------------------------------"
	g++ -o akinator_program $(FLAGS) main_akinator.cpp $(SFML_INCLUDES) $(COMMON_INCLUDES) $(CONFIG_INCLUDES) $(STK_INCLUDES) $(TREE_INCLUDES) $(AKINATOR_INCLUDES) $(COMMON_FILES) $(TREE_FILES) $(AKINATOR_FILES)
	@echo "-----------------------------------------------------------------------------------------"
